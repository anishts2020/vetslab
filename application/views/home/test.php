    ...
    <div class="col-md-3">
        ...
        <button class="btn btn-primary" id="search_btn">Search</button>
										...
										<div class="table-responsive ">
											<table class="table table-bordered table-striped w-100" id="reportTable" style="width: 100%;">
												<thead style="background-color: #003366; color:#fff;">
													<tr>
                                                        ...
                                                        <th class="wd-15p border-bottom-0">Owner's Name</th>
													</tr>
												</thead>
...
$(document).ready(function() {
    ...
    function load_table(from_date = '', to_date = '') {
        ...
        $('#reportTable').DataTable({
            ...
            destroy: true,
            ajax: {
                url: "<?= site_url('report/get_reports'); ?>",
                type: "POST",
                data: {
                    from_date: from_date,
                    to_date: to_date
...
$(document).ready(function() {
    ...
    var table = $('#reportTable').DataTable({
        ...
        buttons: [
            { extend: 'excelHtml5', title: 'Species List' },
            { extend: 'pdfHtml5', title: 'Species List' }
